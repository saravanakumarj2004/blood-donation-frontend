        ...
        <div className="max-w-7xl mx-auto space-y-6 animate-fade-in pb-20 bg-slate-50 min-h-screen p-6">
            ...
            <div className="grid lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-4">
                    <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-slate-200 sticky top-8">
                        ...
                        <form onSubmit={handleSearch} className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    type="number" className="w-full p-2.5 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:border-rose-500 focus:ring-1 focus:ring-rose-500 outline-none transition-all font-semibold text-slate-800 text-sm"
                            ...
                            <div>
                                ...
                                <input
                                    type="text" className="w-full p-2.5 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white focus:border-rose-500 focus:ring-1 focus:ring-rose-500 outline-none transition-all font-semibold text-slate-800 text-sm"
                            ...
                            <button
                                ...
                                className="w-full py-3 mt-4 bg-rose-600 text-white font-bold rounded-lg shadow-sm hover:bg-rose-700 hover:shadow-md active:scale-[0.98] transition-all flex items-center justify-center gap-2 text-sm"
                            >
                ...
                <div className="lg:col-span-8">
                    {!hasSearched ? (
                        <div className="h-full min-h-[400px] flex flex-col items-center justify-center p-12 bg-white border border-dashed border-slate-300 rounded-2xl text-center shadow-sm">
                        ...
                        <div className="space-y-4">
                            ...
                            {results.map(donor => (
                                <div key={donor.id} className="bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:border-slate-300 hover:shadow-md transition-all flex flex-col sm:flex-row items-center justify-between gap-6 group">
                                    <div className="flex items-center gap-5 w-full sm:w-auto">
                                        ...
                                        <div>
                                            <h4 className="text-base font-bold text-slate-900 group-hover:text-blue-600 transition-colors">{donor.name}</h4>
                                    ...
                                    <div className="flex gap-2 w-full sm:w-auto">
                                        <button className="flex-1 sm:flex-none px-4 py-2 rounded-lg bg-slate-50 text-slate-700 border border-slate-200 font-semibold flex items-center justify-center gap-2 hover:bg-slate-100 transition-colors text-sm">
                                            <Bell size={16} /> Alert
                                        </button>
                                        <a href={`tel:${donor.mobile}`} className="flex-1 sm:flex-none px-4 py-2 rounded-lg bg-emerald-600 text-white font-semibold flex items-center justify-center gap-2 shadow-sm hover:bg-emerald-700 active:scale-[0.98] transition-all text-sm">
                                            <Phone size={16} /> Call
                                        </a>
                                    </div>
                                </div>
